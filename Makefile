...
images-build-pipeline:
	cat common/reusable-blocks.yml image-build/image-build.yml | fly -t homelab set-pipeline -n -p images-build -c - -l common/vars/secrets.dec.yml -l common/vars/vars.yml

image-notifications-pipeline:
	cat common/reusable-blocks.yml notification-jobs/image-notifications.yml | fly -t homelab set-pipeline -n -p image-notifications -c - -l common/vars/secrets.dec.yml -l common/vars/vars.yml

misc-notifications-pipeline:
	cat common/reusable-blocks.yml notification-jobs/misc-notifications.yml | fly -t homelab set-pipeline -n -p misc-notifications -c - -l common/vars/secrets.dec.yml -l common/vars/vars.yml
